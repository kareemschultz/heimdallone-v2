...
Phase 11:  Biometric + Geofencing ← ACTIVE (11A spec ✅, 11B DB ✅, 11C API+processor ✅, 11D devices UI ✅, 11E punch review + exception queue UI ✅ → 11F geofence locations + mobile check-in next)
