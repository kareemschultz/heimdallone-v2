...
Helpdesk / Requests (Phase 13 — ACTIVE; 13A spec ✅ → 13B DB ✅ → 13C API ✅ → 13D overview+queue UI ✅ → 13E detail/comments/internal-notes UI ✅ → 13F employee My Requests self-service ✅ → 13G assignment/SLA/approvals next):
