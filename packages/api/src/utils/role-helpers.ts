...
// self-service (own disciplinary explain/appeal; own resignation create/
// withdraw) is gated by the AC actions + handler self-scope, NOT these helpers.
// internalNote on a disciplinary record is redacted SERVER-SIDE from the subject.
//
...
// apps/web/src/lib/rbac.ts — keep byte-aligned. Aligned to the `development` AC
// grant in permissions.ts (lesson #88: align to the GRANT, not prose).
//
