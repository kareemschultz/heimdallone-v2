		...
		<div className="page">
			...
			<div className="payroll-grid">
				<div className="left-col">
					...
					<SettingsSection title="Country rules">
						<div
							style={{
								padding: "10px 12px",
								fontSize: 12.5,
						...
						>
							Statutory PAYE income-tax brackets, NIS rates, ceilings, and
							personal allowances are loaded from the active country profile.
							The active profile is shown on the right. Country profiles are
							managed centrally and update each tax year — they cannot be edited
							per organization.
						</div>
					</SettingsSection>

					<SettingsSection title="Payslip numbering">
						<div
							style={{
								padding: "10px 12px",
								fontSize: 12.5,
						...
						>
							Payslip IDs are auto-generated by Heimdallone for each finalized
							payroll. Custom numbering formats (prefix, padding, year segment)
