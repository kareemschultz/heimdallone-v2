...
- Recruitment + Onboarding (Phase 9): **In progress**
  ...
  - 9D remaining: interview row actions, Job create/edit forms + Settings tab (#96), pipeline quick-view drawer (Decision B).
...
- Next: Phase 9D — Job create/edit forms + Settings tab (#96), interview row actions, pipeline quick-view drawer; then 9E–9G Onboarding, 9H candidate→employee conversion, 9I QA + API denormalization (candidate/opening display fields in interviews.list/offers.list/applications.list).
