...
- Recruitment + Onboarding (Phase 9): **In progress**
  ...
  - 9D remaining: pipeline quick-view drawer (Decision B); brand-new interview scheduling (deferred to pipeline/candidate flow).
